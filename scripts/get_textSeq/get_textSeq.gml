function get_textSeq(_seq){ //GETTING AN TEXT SEQUENCE
	...
	switch(_seq) { //CHECKING WHAT TEXT SEQUENCE THAT I WANT TO RETURN
		...
		case "sans_intro":
			...
			addtext("{face,face_sans1}* my name is sans.\nit's 1 letter off.")
			addtext("{face,face_flowey15}* Oh. What a funny joke...")
			addtext("{face,face_sans1}* i'd love to see some ketchup come out of this\nkid. whatcha think?")
			...
			addtext("{face,face_flowey9}* I'll... Uhhh... Kill... You... Before you kill\nthem?")
			...
			addtext("{face,face_sans1}* he really wants the seventh soul or whatever\nthe books say.")
			...
			addtext("{face,face_sans1}* aw, i thought it would be a funny joke. {z}anyways,\ni can hear him coming.")
			addtext("{face,face_sans1}* his footsteps are very loud.{z}\nlet's go talk to him.")
			...
			addtext("{face,face_sans1}* hide huh?{w,10}\ni think i have the perfect spot for you.")
			addtext("{face,face_flowey4}* Seriously?{w,10}\nnow you want to help?!")
		...
		case "sans_intro1":
			...
			addtext("{face,face_flowey12}* But we-{w,10} ugh,{w,5} whatever!{w,10}\nWe're out of time.{w,10} Let's hide behind that rock.")
			addtext("{face,face_sans1}* hey, he has a name.{w,10}\nit's brock.")
		...
		case "pap_intro":
			...
			addtext("{face,face_sans1}* me?{w,10} of course i am, i found this brock here on\nthe ground.")
		...
		case "pap_intro-2":
			...
			addtext("{face,face_pap}NOW,{w,10} LET'S GO SANS!{w,10}\nLET'S RECALIBRATE MY TRAPS.")
		break;
		...
		case "pap_intro-4":
			...
			addtext("{face,face_flowey13}* What?{w,10} {face,face_flowey11}no!{w,10}\n{face,face_flowey12}that's totally a bad idea, no chance!")
