...
if (asset_get_index("live_init") == -1) show_error("live_init is missing!&Either GMLive is not imported in the project, or the 'GMLive' script got corrupted (try re-importing)&If you don't have GMLive, you can safely remove obj_gmlive and any remaining live_* function calls.&&", 1);
